                        ...
                        >
                            <Tilt options={{ max: 8, scale: 1.01 }}>
                                <div className="h-full p-7 rounded-3xl border border-white/10
                                    ...
                                    transition-all duration-350 group relative overflow-hidden">
                                    {/* Red left accent */}
                                    <div className="absolute top-0 left-0 w-[3px] h-full bg-gradient-to-b from-red-500/80 via-red-600/25 to-transparent rounded-l-3xl" />
                                    <div className="absolute -top-8 -right-8 w-32 h-32 bg-red-500/[0.04] rounded-full blur-2xl group-hover:bg-red-500/[0.09] transition-all duration-500" />
